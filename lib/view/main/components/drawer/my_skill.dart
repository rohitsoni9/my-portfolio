  ...
  Widget build(BuildContext context) {
    return const Column(
      ...
      children: [
        ...
        AnimatedLinearProgressIndicator(
            percentage: 0.5, title: 'NodeJs', image: 'assets/icons/node.png'),
        AnimatedLinearProgressIndicator(
            percentage: 0.7,
            title: 'Angular',
        ...
        AnimatedLinearProgressIndicator(
            ...
            image: 'assets/icons/flutter.png'),
        AnimatedLinearProgressIndicator(
            percentage: 0.65, title: 'Bloc', image: 'assets/icons/bloc.png'),
        AnimatedLinearProgressIndicator(
            percentage: 0.95, title: 'Getx', image: 'assets/icons/dart.png'),
      ],
    );
  }
}
